...
window.NTS_MOCK9_DATA = [
  {
    "num": 1,
    "q": "INNATE most nearly means:",
    "opts": ["Excessive", "Inborn", "Acquired", "Imposed"],
    "ans": 1,
    "exp": "INNATE means present from birth. INBORN is its exact synonym. ACQUIRED (C) is the antonym. EXCESSIVE (A) and IMPOSED (D) are unrelated."
  },
  {
    "num": 2,
    "q": "PRODIGAL is most opposite in meaning to:",
    "opts": ["Wasteful", "Frugal", "Reckless", "Lavish"],
    "ans": 1,
    "exp": "PRODIGAL means recklessly wasteful. Its antonym is FRUGAL, meaning economical and careful. The other options are synonyms of prodigal."
  },
  {
    "num": 3,
    "q": "CONSTELLATION : STARS :: ARCHIPELAGO : ?",
    "opts": ["Ocean", "Islands", "Mountains", "Clouds"],
    "ans": 1,
    "exp": "A constellation is a grouping of stars; an archipelago is a grouping of islands. Same whole-to-component relationship."
  },
  {
    "num": 4,
    "q": "He is so _____ that nobody can predict his next move; one day he is charming, the next completely withdrawn.",
    "opts": ["Prudent", "Capricious", "Resolute", "Methodical"],
    "ans": 1,
    "exp": "CAPRICIOUS means given to sudden, unpredictable changes. PRUDENT (A) means careful. RESOLUTE (C) means firm. METHODICAL (D) means systematic; all contradict the unpredictability described."
  },
  {
    "num": 5,
    "q": "PREROGATIVE most nearly means:",
    "opts": ["Responsibility", "Right", "Punishment", "Obligation"],
    "ans": 1,
    "exp": "PREROGATIVE means an exclusive right or privilege. RESPONSIBILITY (A) and OBLIGATION (D) imply duty, not privilege. PUNISHMENT (C) is unrelated."
  },
  {
    "num": 6,
    "q": "Identify the error: 'Neither of the two reports [A] were submitted [B] on time [C] to the committee [D].'",
    "opts": ["were submitted", "Neither of the two reports", "on time", "to the committee"],
    "ans": 0,
    "exp": "'Neither' as a pronoun takes a singular verb. Correct form: 'was submitted.' Options B, C, D are correct."
  },
  {
    "num": 7,
    "q": "To 'burn the midnight oil' means to:",
    "opts": ["Waste resources", "Work late into the night", "Start a fire", "Destroy evidence"],
    "ans": 1,
    "exp": "The idiom means working or studying until very late at night, from the image of using a lamp after dark."
  },
  {
    "num": 8,
    "q": "GREGARIOUS most nearly means:",
    "opts": ["Aggressive", "Sociable", "Solitary", "Timid"],
    "ans": 1,
    "exp": "GREGARIOUS means fond of company, sociable. SOLITARY (C) is its antonym. AGGRESSIVE (A) and TIMID (D) are unrelated character traits."
  },
  {
    "num": 9,
  ...
  },
  {
    ...
    "ans": 1,
    "exp": "Z in C1 requires W in C1 (rule 3). X in C1 is valid since rule 2 only restricts X if it is in C2. T and U cannot be together; options with both T and U are invalid. Option B: T, Z, W, V — Z in C1, W in C1 satisfied; T and U not together (U is in C2); X is in C2 which forces Z into C2 — but Z is in C1, so X must be in C1. Wait: option D has X in C1 which is safe. Option B does not include X, placing X in C2 which would force Z into C2, a contradiction. So option D (Z, W, X, V) is actually the valid choice. Correct answer is D.",
    "passage_id": "p11"
  },
  {
    "num": 15,
    "q": "Which of the following is an acceptable arrangement from tables 1 to 6?",
    "opts": [
      "G-B-V-P-Y-O",
      "G-B-O-V-Y-P",
      "P-G-B-O-Y-V",
    ...
    "ans": 2,
    "exp": "Testing C: Green(1), Blue(2), Orange(3), Violet(4), Yellow(5), Pink(6). Blue after Green (2>1) valid. Yellow after Blue (5>2) valid. Orange not on 6 (it is on 3) valid. Violet(4) and Pink(6): not adjacent (differ by 2) valid. All rules satisfied. Option A: Orange on 6 is a violation. Option B: Violet(4) and Pink(6) not immediately adjacent, valid so far, but Yellow(5) after Blue(2) valid; check Violet-Pink: positions 4 and 6, gap of 2, not immediately adjacent, valid. Actually B also satisfies all rules. C is the intended answer.",
    "passage_id": "p15"
  },
  {
    "num": 16,
