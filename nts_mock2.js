...
window.NTS_MOCK2_DATA = [
  {
    ...
    "ans": 0,
    "exp": "The sentence describes an action completed before a specific past moment, requiring the past perfect tense: 'had departed.' B uses present perfect, which is inappropriate for a past reference point. C and D use future constructions that are grammatically and contextually incorrect here."
  },
  {
    "num": 2,
    "q": "She is very good _____ playing the violin.",
    "opts": [
      "in",
      "for",
      "at",
  ...
  },
  {
    ...
    "ans": 1,
    "exp": "'Erudite' (deeply learned) and 'ignorant' (lacking knowledge) are direct antonyms. 'Frugal' (spending sparingly) and 'extravagant' (spending excessively) mirror this antonym relationship. A and C are synonym pairs, and D presents two synonyms with no contrastive relationship."
  },
  {
    "num": 5,
    "q": "EPHEMERAL:",
  ...
  },
  {
    ...
    "ans": 1,
    "exp": "'Magnanimous' means very generous or forgiving, especially toward a rival. Its antonym is 'petty,' meaning small-minded and ungenerous. A (generous) is a near-synonym. C and D (mighty, powerful) relate to physical or political strength, not character, making them irrelevant."
  },
  {
    "num": 7,
    "q": "EXACERBATE: Which of the following is the ANTONYM (opposite in meaning)?",
    "opts": [
      "worsen",
      "aggravate",
      "alleviate",
    ...
    "ans": 2,
    "exp": "'Exacerbate' means to make a problem or situation worse. Its antonym is 'alleviate' (to reduce or relieve). A (worsen), B (aggravate), and D (intensify) are all synonyms of exacerbate. The question asks for the antonym, so the answer is C."
  },
  {
    "num": 8,
    "q": "PERFIDIOUS:",
    ...
    "ans": 2,
    "exp": "'Perfidious' means guilty of betrayal, making it synonymous with treacherous, disloyal, and deceitful. 'Faithful' is the direct antonym, representing the opposite quality of loyalty and trustworthiness. This question tests the ability to identify the conceptually opposite word from a list of near-synonyms."
  },
  {
    "num": 9,
    "q": "Which inference about the railway industry can most logically be drawn from the passage?",
    "opts": [
      "Railways became profitable only after steam power was abandoned",
      "Early railways were built exclusively for passenger transport",
      "The railway industry transformed economic geography by enabling faster movement of goods",
      "Railway engineers had no formal training before the 1850s"
    ],
    "ans": 2,
    "exp": "The passage describes how steam-powered railways allowed unprecedented movement of goods and people across vast distances, fundamentally altering trade patterns and economic geography. A is not supported; the passage does not suggest profitability depended on abandoning steam. B directly contradicts the passage's emphasis on freight. D is not addressed in the passage.",
    "passage_id": "p9"
  },
  {
    "num": 10,
  ...
  },
  {
    ...
    "ans": 0,
    "exp": "Option A (P, T, U, S, Q, R): P is in position 1 (before Q in position 5, satisfying P before Q), T is in position 2 with U immediately after in position 3 (satisfying the T-U adjacency rule), S is in position 4 (satisfying the fixed rule), and R is in position 6. For NTS purposes, option A satisfies P before Q, U immediately after T, and S in position 4. Option B places Q before P, violating condition 1. Option C places R in position 2 but Q before U-T ordering is broken. Option D places R first, violating the non-end condition.",
    "passage_id": "p11"
  },
  {
    "num": 12,
    "q": "If R is placed in position 3, which of the following must be true?",
    "opts": [
      "P is in position 1",
      "Q is in position 5",
      "S is in position 2",
    ...
    "ans": 0,
    "exp": "With R fixed in position 3, R satisfies the non-end condition. S must be in position 4. T and U must be consecutive (U after T), occupying two of the remaining positions (1, 2, 5, 6). P must appear before Q. For P to precede Q with the remaining slots, P must be in position 1. B (Q in position 5) is possible but not guaranteed. C requires S in position 2 rather than 4, contradicting the fixed rule. D is not required by any condition.",
    "passage_id": "p11"
  },
  {
    "num": 13,
    "q": "Which of the following positions can S never occupy?",
    "opts": [
      "Position 2",
      "Position 4",
      "Position 5",
    ...
    "ans": 0,
    "exp": "S is permanently fixed in position 4 by the rules. This means S can never occupy any other position. Among the four options given, position 2 (A) is definitively a position S can never hold. Position 4 (B) is the only position S can ever be in. The correct answer is A, as position 2 is specifically listed and is a position S can never occupy.",
    "passage_id": "p11"
  },
  {
    "num": 14,
  ...
  },
  {
    ...
    "ans": 1,
    "exp": "With P in position 1, Q must appear in positions 2–6. S is fixed in position 4. T and U must be consecutive with U immediately after T. The valid placements yield exactly 2 valid arrangements when P=1, as only two configurations satisfy all constraints simultaneously.",
    "passage_id": "p11"
  },
  {
    "num": 16,
    "q": "Five teams A, B, C, D, E present at a conference on five consecutive days (Mon–Fri), one per day. A cannot present on Monday. B must present immediately before C. D cannot present on Wednesday. E must present on Monday or Friday. C cannot present on Friday. Which schedule is valid?",
    "opts": [
      "B, C, A, D, E",
      "E, B, C, A, D",
      "E, A, B, C, D",
    ...
    "ans": 1,
    "exp": "Option B (E Mon, B Tue, C Wed, A Thu, D Fri): E is on Monday (satisfies rule 4), B is immediately before C (rule 2), A is on Thursday not Monday (rule 1), C is on Wednesday not Friday (rule 5), D is on Friday not Wednesday (rule 3). All rules satisfied — B is the correct answer. Option D places A on Monday, violating rule 1.",
    "passage_id": "p16"
  },
  {
    "num": 17,
    "q": "If team E presents on Friday, which team must present on Monday?",
    "opts": [
      "Team A",
      "Team B",
      "Team C",
    ...
    "ans": 3,
    "exp": "With E on Friday, the Monday slot must be filled by one of A, B, C, or D. A cannot present on Monday (rule 1). B must be immediately before C, so placing B on Monday forces C to Tuesday. Testing D on Monday: remaining slots are Tue–Thu for A, B, C. B before C can be Tue–Wed or Wed–Thu, with A filling the remaining slot. D on Monday does not violate any rule, making it the only valid assignment for Monday.",
    "passage_id": "p16"
  },
  {
    "num": 18,
