...
window.NTS_MOCK1_DATA = [
  ...
  },
  {
    ...
    "ans": 2,
    "exp": "The rules state that U must be scheduled immediately after T. If T is in slot 1, then U must be in slot 2 — this is the only possibility and is therefore always true. Option A is not guaranteed: P can be in slot 3 or 4 depending on where R lands. Option B is not guaranteed: R can be in slot 3 or 4 (R cannot be first or last, so slots 2–5 are valid, but slot 2 is taken by U and slot 5 by S, leaving 3 or 4). Option D is not guaranteed: Q must come after P and slot 6 is the most constrained position for Q, but Q's exact slot varies.",
    "passage_id": "p19"
  },
  {
    "num": 21,
