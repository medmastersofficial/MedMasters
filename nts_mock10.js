...
window.NTS_MOCK10_DATA = [
  ...
  },
  {
    ...
    "opts": ["Festive", "Calm", "Restless", "Active"],
    "ans": 1,
  ...
  },
  {
    ...
    "opts": ["verbosity", "lucidity", "obscurity", "ambivalence"],
    "ans": 1,
  ...
  },
  {
    ...
    "opts": ["got into", "got over", "got down to", "got around"],
    "ans": 1,
  ...
  },
  {
    ...
    "opts": [
      "Patient is a minor",
      "Emergency; patient cannot consent",
      "Clinician judges patient incapable",
      "An advance directive is present"
    ],
    "ans": 1,
  ...
  },
  {
    ...
    "opts": [
      ...
      "Liability regardless of competence",
      "Liability only when harm occurs",
      "Battery applies in emergencies only"
    ],
    "ans": 1,
  ...
  },
  {
    ...
    "opts": [
      "C is selected",
      "B is selected and G is not selected",
      "F is selected",
      "D is selected"
    ],
    "ans": 1,
  ...
  },
  {
    ...
    "opts": [
      "Raised capillary oncotic pressure",
  ...
  },
  {
    ...
    "opts": [
      "Defective voltage-gated Na⁺ channel",
      "Defective CFTR protein",
      "Defective aquaporin-2",
      "Defective Ca²⁺ channel (Lambert-Eaton)"
    ],
    "ans": 1,
  ...
  },
  {
    ...
    "opts": [
      "Femoral nerve (retractor pressure)",
      "Common peroneal nerve (fibular neck)",
      "Sciatic nerve (acetabular reaming)",
  ...
  },
  {
    ...
    "opts": [
      "Facial nerve fibres re-innervating skin",
      "Auriculotemporal nerve misdirection",
      "Greater auricular nerve",
      "Chorda tympani re-innervating skin"
    ],
    "ans": 1,
  ...
  },
  {
    ...
    "opts": [
      "Direct pelvic floor extension",
      "Batson's venous plexus (haematogenous)",
      "Lymphatic spread via para-aortic nodes",
  ...
  },
  {
    ...
    "opts": ["Frontal bone", "Maxilla", "Zygomatic bone", "Ethmoid bone"],
    "ans": 1,
  ...
  },
  {
    ...
    "opts": ["Vitamin B12", "Pyridoxine (vitamin B6)", "Folate", "Thiamine"],
    "ans": 1,
  ...
  },
  {
    ...
    "opts": ["Amlodipine", "ACE inhibitor", "Thiazide diuretic", "Beta blocker"],
    "ans": 1,
    "exp": "In bilateral renal artery stenosis the kidney depends on angiotensin II to maintain efferent arteriolar tone and GFR. ACE inhibitors remove this support, precipitating acute kidney injury. Amlodipine (A) and thiazides (C) are safe alternatives."
  },
  {
    "num": 48,
    "q": "A patient on lithium has coarse tremor, ataxia, and confusion. Serum lithium is 2.8 mmol/L. Immediate action:",
    "opts": ["Double the dose", "Stop lithium; IV saline to promote renal excretion", "Add haloperidol", "Switch to valproate without stopping"],
    "ans": 1,
  ...
  },
  {
    ...
    "opts": [
      ...
      "Adenocarcinoma; bone mets",
      "Large cell; ectopic PTH"
    ],
    "ans": 1,
  ...
  },
  {
    ...
    "opts": [
      ...
      "TIA; same-day specialist review",
      "Syncope",
  ...
  },
  {
    ...
    "opts": [
      "NSTEMI",
      "Stable angina; coronary angiography",
  ...
  },
  {
    ...
    "opts": [
      "Paralytic ileus",
      "Anastomotic leak; return to theatre",
      "Wound infection",
      "Pulmonary embolism"
    ],
    "ans": 1,
  ...
  },
  {
    ...
    "opts": ["Fever", "Absent cremasteric reflex", "Nausea and vomiting", "Scrotal erythema"],
    "ans": 1,
  ...
  },
  {
    ...
    "opts": ["Staphylococcus aureus", "Clostridium perfringens", "E. coli", "Pseudomonas aeruginosa"],
    "ans": 1,
  ...
  },
  {
    ...
    "opts": ["Annual ultrasound surveillance", "Elective surgical or endovascular repair", "Emergency repair", "Anticoagulation only"],
    "ans": 1,
  ...
  {
    "num": 66,
    "q": "A 32-year-old woman from Lahore presents with 8 months of oligomenorrhoea, weight gain, hirsutism, and acne. Fasting glucose is 6.2 mmol/L. LH:FSH ratio is 3:1. Pelvic ultrasound shows 14 follicles in the right ovary and 12 in the left, all <10 mm, in a 'pearl necklace' pattern. Diagnosis:",
    "opts": [
      "Hyperprolactinaemia",
      "PCOS",
    ...
    "ans": 1,
    "exp": "PCOS (Rotterdam criteria, 2 of 3): oligo/anovulation (oligomenorrhoea), clinical/biochemical hyperandrogenism (hirsutism, acne), polycystic ovaries on ultrasound (≥12 follicles per ovary or ovarian volume >10 mL). Elevated LH:FSH ratio (>2:1) and insulin resistance (glucose 6.2) are common. PCOS is the most common endocrine disorder in women of reproductive age in Pakistan. Ten Teachers identifies insulin resistance and hyperandrogenism as the two key metabolic drivers. Hyperprolactinaemia (A) causes galactorrhoea and normal androgens. POI (C) shows elevated FSH with low oestrogen."
  },
  {
    "num": 67,
    ...
    "opts": [
      ...
      "Head compression; reassure"
    ],
    "ans": 1,
    "exp": "Late decelerations are caused by uteroplacental insufficiency: reduced blood flow during contractions leads to fetal hypoxia, triggering a vagal response after the contraction peak. They are a serious non-reassuring CTG pattern. Repetitive late decelerations for 20 minutes require urgent senior obstetrician review and likely expedited delivery (emergency caesarean at 7 cm dilation)."
  },
  {
    "num": 68,
  ...
  },
  {
    ...
    "opts": [
      "Chlamydia persistent infection",
      "HPV types 16 and 18",
      "HSV type 2",
      "Oestrogen excess"
    ],
  ...
  },
  {
    ...
    "opts": [
      ...
      "Non-functioning adenoma; surgery",
      "Sheehan's syndrome"
    ],
    "ans": 1,
  ...
  },
  {
    ...
    "opts": [
      ...
      "Pleural effusion from infection",
  ...
  },
  {
    ...
    "opts": [
      "Aspirin; neurology in 48h",
      "High-dose prednisolone immediately",
      "NSAIDs + ophthalmology",
  ...
  },
  {
    ...
    "opts": ["Persistent fetal vasculature", "Retinoblastoma", "Congenital cataract", "Coat's disease"],
    "ans": 1,
  ...
  },
  {
    ...
    "opts": [
      "Rifampicin causes photosensitivity",
      "IRIS if ART started too soon",
      "Withhold TB treatment until CD4 >200",
      "HIV prevents granuloma formation"
    ],
    "ans": 1,
  ...
  },
  {
    ...
    "opts": ["COPD", "Coal worker's pneumoconiosis", "Idiopathic pulmonary fibrosis", "Tuberculosis"],
    "ans": 1,
  ...
  },
  {
    ...
    "opts": ["Pulmonary TB", "Congestive cardiac failure", "Malignancy", "Parapneumonic effusion"],
    "ans": 1,
  ...
  },
  {
    ...
    "opts": ["High-flow O₂ 15 L/min", "NIV (BiPAP)", "IV diazepam", "Immediate intubation"],
    "ans": 1,
  ...
  },
  {
    ...
    "opts": [
      "Hyperglycaemia",
      "Hypokalaemia (prolonged QTc; arrhythmia)",
  ...
  },
  {
    ...
    "opts": [
      "Discharge; abstinence will resolve it",
