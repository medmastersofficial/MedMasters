...
window.MM.fpsc_past_2 = [
  ...
  {
    "q": "Which of the following words is closest in meaning to MAGNANIMOUS?",
    "opts": [
      "benevolent",
      "frugal",
      "obstinate",
    ...
    "ans": 0,
    "exp": "MAGNANIMOUS means generous in forgiving and noble in spirit. BENEVOLENT means well-meaning and kindly, making it the closest synonym. FRUGAL means thrifty or sparing, which is unrelated. OBSTINATE means stubbornly refusing to change, which is the opposite of magnanimous in temperament. VINDICTIVE means seeking revenge, which directly contradicts the forgiving nature of magnanimity.",
    "section": "English",
    "num": 5
  },
  {
    "q": "Which of the following is the ANTONYM of PERFIDIOUS?",
    "opts": [
      "treacherous",
      "deceitful",
      "steadfast",
  ...
  },
  {
    ...
    "ans": 0,
    "exp": "'Put off' is a phrasal verb meaning to postpone. The other options carry different meanings (put up = tolerate/erect, put in = submit, put on = wear).",
    "section": "English",
    "num": 8
  },
  {
  ...
  },
  {
    ...
    "opts": [
      "He finished his shift, but he went straight to the library.",
      "After finishing his shift, he went straight to the library.",
      "He finished his shift or he went straight to the library.",
  ...
  },
  {
    ...
    "ans": 1,
    "exp": "TRANSPARENT means easy to see through or understand; its opposite is OBSCURE, meaning unclear or hidden from understanding.",
    "section": "English",
    "num": 14
  },
  {
  ...
  },
  {
    ...
    "ans": 1,
    "exp": "PROLIFIC describes something or someone producing a large quantity of work or offspring, e.g. 'a prolific writer'.",
    "section": "English",
    "num": 16
  },
  {
  ...
  },
  {
    ...
    "ans": 0,
    "exp": "An ARSENAL is a collection of weapons or a place where weapons and military equipment are stored.",
    "section": "English",
    "num": 19
  },
  {
  ...
  {
    "q": "A Basic Health Unit conducting immunization drives and health education sessions is primarily practising:",
    "opts": [
      "Tertiary prevention",
      "Curative care",
  ...
  {
    "q": "The '18th Constitutional Amendment' significantly affected health policy in Pakistan by:",
    "opts": [
      "Centralizing all health decisions under the federal government",
      "Devolving health as a subject primarily to the provinces",
      "Abolishing the Ministry of Health entirely",
  ...
  {
    "q": "Pakistan's Sehat Sahulat Program covers the cost of care primarily at which level(s) of the health system?",
    "opts": [
      "Primary care only (BHUs and RHCs)",
  ...
  {
    "q": "The mother of a 2-year-old boy reports that he holds his breath and turns blue briefly during tantrums. These breath-holding spells in toddlers typically resolve spontaneously by what age?",
    "opts": [
      "4 years",
      "5 years",
      "6 years",
  ...
  {
    "q": "A 50-year-old man with type 2 diabetes and stable angina is started on metformin and a statin. Which additional class of drug most reduces cardiovascular mortality in this setting?",
    "opts": [
  ...
  {
    "q": "A 60-year-old smoker presents with painless, gross haematuria. What is the most important diagnosis to exclude first?",
    "opts": [
